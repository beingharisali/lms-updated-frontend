...
const AddTeachers = () => {
  ...
  // if (!token || !user) {
  //   console.warn("⚠️ No authentication token or user found");
  //   setMessage({
  //     text: "Please login to add teachers",
  //     type: "error",
  //   });
  //   console.log("token", token);
  //   console.log("user", user);
  // } else {
  //   console.log("✅ User authenticated:", JSON.parse(user).role);
  ...
  return (
    <div className="flex flex-col md:flex-row min-h-screen bg-[#eff6f9]">
      ...
      <div className="flex flex-col flex-1 bg-[#eff6f9]">
        <AdminHeader
          breadcrumb="Super Admin / Add Teacher"
          title="Add Teacher"
        />
